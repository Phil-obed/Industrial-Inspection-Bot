...
const int TRIG_PINS[NUM_SENSORS] = {5, 19, 22, 4, 2};
const int ECHO_PINS[NUM_SENSORS] = {18, 21, 23, 35, 34};
...
void loop() {
  ...
  // --- Print Filtered Values Only (CSV format) ---
  for (int i = 0; i < NUM_SENSORS; i++) {
    Serial.print(out[i], 2); // 2 decimal places
